...
The dashboard is hosted on SciLifeLab serve and can be found here: [rm-qrp-attitudes.serve.scilifelab.se](https://rm-qrp-attitudes.serve.scilifelab.se/app/rm-qrp-attitudes)

## How the dashboard is built
The dashboard is built using R (4.5.1) with Shiny. The code of the Shiny app can be found at /app/app.R; the app can be run locally e.g. using RStudio. The R packages used are listed in the code and specified with package versions in the renv.lock file.
